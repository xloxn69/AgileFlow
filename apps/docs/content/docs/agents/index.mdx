---
title: Agents
description: 29 specialized AI agents for every aspect of software development. Each agent is an expert in their domain, ready to help with specific tasks.
---

# Agents

AgileFlow includes **29 specialized agents**, each an expert in their domain. Agents can be spawned by the `/babysit` mentor or invoked directly using the Task tool.
