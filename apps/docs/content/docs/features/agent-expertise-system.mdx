...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="images/agent-expertise-arch.dark.svg" />
  <img alt="Agent Expertise Architecture" src="images/agent-expertise-arch.light.svg" />
</picture>
