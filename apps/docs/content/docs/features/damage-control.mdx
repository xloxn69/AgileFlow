...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="images/damage-control-flow.dark.svg" />
  <img alt="Damage Control Flow" src="images/damage-control-flow.light.svg" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="images/damage-control-arch.dark.svg" />
  <img alt="Damage Control Architecture" src="images/damage-control-arch.light.svg" />
</picture>
