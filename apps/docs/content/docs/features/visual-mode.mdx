...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="images/visual-mode-protocol.dark.svg" />
  <img alt="Verified Prefix Protocol" src="images/visual-mode-protocol.light.svg" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="images/visual-mode-loop.dark.svg" />
  <img alt="Visual Mode Loop Integration" src="images/visual-mode-loop.light.svg" />
</picture>
