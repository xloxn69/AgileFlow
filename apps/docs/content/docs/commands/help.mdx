...
├── 02-practices/     # Development practices and patterns
├── 03-decisions/     # Architecture Decision Records (ADRs)
├── 04-architecture/  # System architecture and design
├── 05-epics/         # Epic tracking
├── 06-stories/       # User story tracking
├── 07-testing/       # Test documentation
├── 08-project/       # Project overview and metrics
├── 09-agents/        # Agent communication and status
