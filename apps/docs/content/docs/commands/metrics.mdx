...
<Accordion type="multiple">
  ...
  <AccordionItem value="flow">
    ...
    <AccordionContent>
      Stories spending time in ready queue (start work faster), in review (faster code reviews), or blocked (unblock faster). Improve by reducing wait time, not by working faster.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="export">
    <AccordionTrigger>Can I export metrics history?</AccordionTrigger>
    <AccordionContent>
      Yes, save reports from multiple runs and compare. Use `FORMAT=csv` for spreadsheet analysis.
    </AccordionContent>
  </AccordionItem>
</Accordion>
