...
<Accordion type="multiple">
  <AccordionItem value="variable">
    ...
    <AccordionContent>
      Possible causes: stories too varied in size (standardize estimates), frequent interruptions (protect work time), blockers slowing completion (unblock faster), or team capacity changes (new members, absences).
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="data-points">
    <AccordionTrigger>How many data points do I need?</AccordionTrigger>
    <AccordionContent>
      At least 3 time periods for reliability. Less than 5 periods = low confidence forecast.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="onboarding">
    <AccordionTrigger>Should I include velocity during onboarding?</AccordionTrigger>
    <AccordionContent>
      No, exclude first sprints. New team members lower velocity temporarily.
    </AccordionContent>
  </AccordionItem>
