...
<Accordion type="multiple">
  <AccordionItem value="wip">
    ...
    <AccordionContent>
      Default is 2 stories per agent in "in-progress" or "in-review" status. When an agent reaches 2, they should finish stories before starting new ones.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="export">
    <AccordionTrigger>Can I export the board?</AccordionTrigger>
    <AccordionContent>
      Yes, use `FORMAT=markdown` or `FORMAT=html` to get exportable formats.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="update">
    <AccordionTrigger>How often is the board updated?</AccordionTrigger>
    <AccordionContent>
      The board reads from `docs/09-agents/status.json` which updates whenever you run `/agileflow:status`. Refresh the board to see latest changes.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="estimates">
    <AccordionTrigger>What do the estimates mean?</AccordionTrigger>
    <AccordionContent>
      Estimates show how long the story should take (in days). Use this when assigning work to agents.
    </AccordionContent>
  </AccordionItem>
</Accordion>
