...
4. End-of-sprint: Run /velocity to update historical data
...
Next Steps:
${MODE == "suggest" && "1. Review commitment and run /sprint-plan MODE=commit to finalize"}
${MODE == "commit" && "1. ✅ Sprint committed! Stories updated in status.json"}
2. Assign first stories: /assign STORY=US-0043 (highest priority)
3. Monitor progress: /board
4. Track blockers: /blockers
5. Sync to external systems: /github-sync or /notion-export
```
