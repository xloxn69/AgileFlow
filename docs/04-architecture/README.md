...
|----------|-------------|
| [Commands](./commands.md) | All 68 slash commands |
| [Subagents](./subagents.md) | All 29 specialized agents |
...
- **Commands**: 68 slash commands for agile workflows
- **Agents**: 29 domain-specialized experts
